 ...
 * @author Nick Eyring
 */
public class GeckoGUIb extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GeckoGUIb.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
