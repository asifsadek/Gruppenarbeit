 ...
 * @see GetRevisionTest
 */
public class GetRevisionH extends MWAction {
	...
	private static final Logger LOG = Logger.getLogger(GetRevisionH.class);
	 ...
	 */
	public GetRevisionH(final String articlename, final int property) {
